...
def desenhar_roi1(atual, anterior, nome_classe):
    ...
    cv2.imwrite("imgApresentacao2/0.jpg", fundo)
    ...
    cv2.imwrite("imgApresentacao2/blackhat1.jpg", fgmask)
    fgmask	= fgmask-y
    
    cv2.imwrite("imgApresentacao2/blackhat2.jpg", fgmask)

    tipo= cv2.THRESH_BINARY	+ cv2.THRESH_OTSU
    limiar,fgmask= cv2.threshold(fgmask,0,	255,tipo)
    cv2.imwrite("imgApresentacao2/1.jpg", fgmask)
    ...
    cv2.imwrite("imgApresentacao2/2.jpg", res)
    ...
    cv2.imwrite("imgApresentacao2/6.jpg", imagemProcessada)
    ...
    cv2.imwrite("imgApresentacao2/7.jpg", imagemProcessada)
    ...
    if contours:
        ...
        cv2.imwrite("imgApresentacao2/re.jpg",drawing)
...
def train():
        ...
        for name in nameClasse:
            ...
            for file in sorted_nicely(files):
                ...
                limite= 100 #limite de imagem a ser processada
                im.append(atual)
